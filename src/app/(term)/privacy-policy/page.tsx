...
1.5. Chính sách này được áp dụng cho cả Người ký gửi & cho tặng và Người mua đang sử dụng Dịch vụ trừ khi có tuyên bố rõ ràng ngược lại.`}
      </p>
      <h1 className="text-2xl font-semibold">2. KHI NÀO Share2Receive SẼ THU THẬP DỮ LIỆU CÁ NHÂN?</h1>
      <p className="text-lg whitespace-pre-wrap">{`2.1. Chúng tôi sẽ/có thể thu thập dữ liệu cá nhân về bạn:`}</p>
      <ul className="list-disc ml-10 text-lg">
        ...
        <li>
          Khi bạn tương tác với chúng tôi, chẳng hạn như thông qua các cuộc gọi điện thoại (có thể được ghi âm lại), thư
        ...
        <li>
          ...
          hoặc Các Dịch Vụ của chúng tôi. Trường hợp này bao gồm thông qua tập tin cookie mà chúng tôi có thể triển khai
          khi bạn tương tác với các Nền tảng hoặc Trang Web của chúng tôi;
        </li>
        <li>Khi bạn cấp quyền trên thiết bị của bạn để chia sẻ thông tin với ứng dụng hoặc Nền tảng của chúng tôi</li>
        <li>
          Khi bạn liên kết tài khoản Share2Receive với tài khoản mạng xã hội của bạn hoặc các tài khoản bên ngoài khác hoặc sử
          dụng các tính năng mạng xã hội khác, phù hợp với các chính sách của nhà cung cấp
        </li>
        ...
        <li>Khi bạn đăng ký tham gia một cuộc thi; hoặc</li>
        <li>Khi bạn gửi dữ liệu cá nhân của bạn cho chúng tôi vì bất kỳ lý do gì.</li>
      </ul>

      <h1 className="text-2xl font-semibold">3. Share2Receive SẼ THU THẬP NHỮNG DỮ LIỆU GÌ?</h1>
      <p className="text-lg whitespace-pre-wrap">{`3.1. Dữ liệu cá nhân mà Share2Receive có thể thu thập bao gồm:`}</p>
      <ul className="list-disc ml-10 text-lg">
        <li>Họ tên;</li>
        <li>Địa chỉ email;</li>
        <li>Ngày sinh;</li>
        ...
        <li>Thông tin về mạng của bạn và những người và tài khoản mà bạn có tương tác;</li>
        <li>Hình ảnh hoặc âm thanh hoặc video;</li>
        <li>
          Thông tin về nhân thân được cấp bởi chính phủ hoặc các thông tin khác phục vụ cho các mục đích đánh giá pháp
          lý, nhận biết khách hàng, xác minh thông tin hoặc phòng chống gian lận của chúng tôi
        </li>
        <li>
          Dữ liệu truyền thông hoặc liên lạc, ví dụ như các tùy chọn nhận thông tin quảng cáo từ chúng tôi hoặc các bên
          thứ ba của bạn, tùy chọn phương tiện liên lạc và lịch sử thông tin liên lạc với chúng tôi, các nhà cung cấp
...
4.3. Như khi bạn xem các trang trên trang web hoặc ứng dụng di động của chúng tôi, khi bạn xem các nội dung và quảng cáo và truy cập vào phần mềm khác trên Nền tảng của chúng tôi hoặc thông qua Dịch vụ, phần lớn các thông tin tương tự được gửi đến cho chúng tôi (bao gồm nhưng không giới hạn, địa chỉ IP, hệ điều hành, v.v..); nhưng, thay vì các số lượt xem trang, thiết bị của bạn gửi đến chúng tôi các thông tin về nội dung, quảng cáo được xem và/hoặc phần mềm được cài đặt bởi các Dịch vụ và Nền tảng và thời điểm.`}</p>
      <h1 className="text-2xl font-semibold">5. COOKIES</h1>
      <p className="text-lg whitespace-pre-wrap">
...
5.2. Bạn có thể từ chối sử dụng cookie bằng cách chọn các thiết lập thích hợp trên trình duyệt hoặc thiết bị của bạn. Tuy nhiên, vui lòng lưu ý rằng nếu bạn thực hiện thao tác này bạn có thể không sử dụng được các chức năng đầy đủ của Nền tảng hoặc Các Dịch Vụ của chúng tôi.`}
      ...
      <h1 className="text-2xl font-semibold">6. CHÚNG TÔI SỬ DỤNG THÔNG TIN BẠN CUNG CẤP CHO CHÚNG TÔI NHƯ THẾ NÀO?</h1>
      <p className="text-lg font-semibold">
        {`6.1. Chúng tôi có thể thu thập, sử dụng, tiết lộ và/hoặc xử lý dữ liệu cá nhân của bạn cho các mục đích sau đây:`}
      </p>
      <ul className="list-disc ml-10 text-lg">
        <li>
          Để xem xét và/hoặc xử lý đơn đăng ký/giao dịch của bạn với chúng tôi hoặc giao dịch hay thư từ của bạn với các
          bên thứ ba qua Các Dịch Vụ;
        </li>
        <li>
          Để quản lý, điều hành, cung cấp và/hoặc quản lý việc bạn sử dụng và/hoặc truy cập Các Dịch Vụ và các Nền tảng
          của chúng tôi (bao gồm các sở thích của bạn), cũng như quan hệ và tài khoản người dùng của bạn với chúng tôi;
        </li>
        <li>
          Để đáp ứng, xử lý, giải quyết hoặc hoàn tất một giao dịch và/hoặc đáp ứng các yêu cầu của bạn đối với các sản
          phẩm và dịch vụ nhất định và thông báo cho bạn về các vấn đề dịch vụ và các hoạt động tài khoản bất thường;
        </li>
        <li>
        ...
        <li>
          Để đánh giá và đưa ra các quyết định liên quan đến hồ sơ tín dụng và rủi ro của bạn và tính đủ điều kiện cho
          các sản phẩm tín dụng;
        </li>
        <li>
          Để duy trì và quản lý bất kỳ bản cập nhật phần mềm nào và/hoặc các bản cập nhật khác và sự hỗ trợ có thể được
          yêu cầu tùy lúc nhằm đảm bảo Các Dịch Vụ của chúng tôi hoạt động suôn sẻ;
        </li>
        <li>
        ...
        <li>
          ...
          thư hoặc cách khác nhằm mục đích quản trị và/hoặc quản lý quan hệ của bạn với chúng tôi hoặc việc bạn sử dụng
          Các Dịch Vụ của chúng tôi, chẳng hạn như ở việc truyền đạt thông tin hành chính cho bạn liên quan đến Các Dịch
          Vụ của chúng tôi. Bạn xác nhận và đồng ý rằng sự liên lạc như thế của chúng tôi có thể là theo cách gửi thư
          qua đường bưu điện, tài liệu hoặc thông báo cho bạn, có thể gồm có tiết lộ dữ liệu cá nhân nhất định về bạn để
          cung cấp các tài liệu đó cũng như trên bao bì/phong bì;
        </li>
        <li>
          Để cho phép các người dùng khác tương tác hoặc liên lạc với bạn hoặc thấy một số hoạt động của bạn trên Nền
          tảng, bao gồm để thông báo cho bạn khi một người dùng khác đã gửi cho bạn một tin nhắn riêng tư hoặc đăng nhận
          xét về bạn trên Nền tảng hoặc để liên kết với việc bạn sử dụng các tính năng xã hội trên Nền tảng;
        </li>
        <li>
          ...
          Dịch Vụ của chúng tôi, để giới thiệu sản phẩm và/hoặc dịch vụ theo sự quan tâm của bạn, để cải thiện Các Dịch
          Vụ hoặc sản phẩm của chúng tôi và/hoặc để cải thiện trải nghiệm khách hàng của bạn;
        </li>
        <li>
          Để cho phép kiểm tra và khảo sát khác để, ngoài những hoạt động khác, xác thực quy mô và thành phần của đối
          tượng mục tiêu của chúng tôi, và hiểu được trải nghiệm của họ với Các Dịch Vụ của Share2Receive;
        </li>
        <li>
          Vì mục đích tiếp thị và quảng cáo, trong trường hợp này, để gửi cho bạn qua các phương tiện và phương thức
          liên lạc khác nhau, thông tin và tài liệu tiếp thị và quảng bá liên quan đến các sản phẩm và/hoặc dịch vụ (bao
          gồm, nhưng không giới hạn các sản phẩm và/hoặc dịch vụ của các bên thứ ba mà Share2Receive có thể hợp tác hoặc liên
          kết) mà Share2Receive (và/hoặc các bên liên kết hoặc công ty có liên quan của nó) có thể bán, tiếp thị hoặc quảng
          bá, cho dù các sản phẩm hoặc dịch vụ đó tồn tại vào lúc này hoặc được tạo ra trong tương lai. Bạn có thể hủy
          đăng ký nhận các thông tin tiếp thị tại bất cứ thời điểm nào bằng cách sử dụng chức năng hủy đăng ký trong các
          tài liệu tiếp thị điện tử. Chúng tôi có thể sử dụng các thông tin liên hệ của bạn để gửi các bản tin và/hoặc
          tài liệu truyền thông từ chúng tôi hoặc từ các công ty có liên quan của chúng tôi;
        </li>
        <li>
          Để đáp ứng các thủ tục pháp lý hoặc để tuân thủ hoặc theo quy định của pháp luật hiện hành, và các yêu cầu của
          cơ quan nhà nước có thẩm quyền hoặc yêu cầu của bất cứ cơ quan tài phán nào hoặc khi chúng tôi thực sự tin
          tưởng rằng việc tiết lộ thông tin là cần thiết, bao gồm nhưng không giới hạn, đáp ứng các yêu cầu đáp ứng các
          yêu cầu công bố thông tin theo yêu cầu của bất kỳ luật ràng buộc nào đối với Share2Receive hoặc các công ty hoặc chi
          nhánh liên quan của Share2Receive (bao gồm, nếu có, việc hiển thị tên, chi tiết liên hệ và chi tiết công ty của
          bạn);
        </li>
        <li>
        ...
        <li>
          Để thực hiện quy trình tìm hiểu và xác minh hoặc các hoạt động sàng lọc khác (bao gồm nhưng không giới hạn
          kiểm tra lý lịch) tuân thủ các nghĩa vụ theo quy định pháp luật hoặc cơ quan nhà nước có thẩm quyền hoặc các
          thủ tục kiểm soát rủi ro của chúng tôi, có thể được pháp luật yêu cầu hoặc có thể đã được chúng tôi áp dụng;
        </li>
        <li>Để kiểm tra Các Dịch Vụ của chúng tôi hoặc hoạt động của Share2Receive</li>
        <li>
          Để ngăn chặn hoặc điều tra bất kỳ hoạt động gian lận thực tế hoặc bị nghi ngờ nào đối với Điều khoản dịch vụ
          của chúng tôi, gian lận, các hành vi phi pháp, thiếu sót hay hành vi sai trái nào, cho dù có liên quan đến
          việc bạn sử dụng Các Dịch Vụ của chúng tôi hay không hay bất kỳ vấn đề nào phát sinh từ quan hệ của bạn với
          chúng tôi;
        </li>
        <li>
          Để đáp ứng bất cứ các mối đe dọa hoặc yêu cầu thực tế nào được khẳng định chống lại Share2Receive hoặc các yêu cầu
          khác liên quan đến các Nội dung vi phạm quy định của các bên thứ ba;
        </li>
        <li>
          Để lưu trữ, lập máy chủ, sao lưu (cho dù là vì mục đích khôi phục sau thảm họa hoặc mục đích khác) đối với dữ
        ...
        <li>
          ...
          tiềm năng, trường hợp giao dịch đó liên quan đến Share2Receive như một bên tham gia hoặc chỉ liên quan đến một công
          ty hay công ty liên kết của Share2Receive như một bên tham gia hoặc liên quan đến Share2Receive và/hoặc bất kỳ một hay
          nhiều công ty hoặc công ty liên kết của Share2Receive như (các) bên tham gia, và có thể có các tổ chức bên thứ ba
          khác tham gia giao dịch như thế. &quot;Giao dịch tài sản kinh doanh&quot; là các giao dịch mua, bán, cho thuê,
          sáp nhập, hợp nhất hoặc bất kỳ hoạt động mua lại, thanh lý hay tài trợ nào của một tổ chức hoặc một phần của
          một tổ chức hoặc của bất kỳ hoạt động kinh doanh hay tài sản nào của một tổ chức; và/hoặc
        </li>
        <li>
          Bất kỳ mục đích nào mà chúng tôi thông báo cho bạn tại thời điểm xin sự cho phép của bạn. (gọi chung là “Các
          Mục Đích”)
        </li>
      </ul>
      <p className="text-lg whitespace-pre-wrap">
        {`6.2. Bạn xác nhận, cho phép và đồng ý rằng chúng tôi có thể truy cập, lưu trữ và tiết lộ thông tin Tài khoản và Nội dung của bạn nếu luật pháp yêu cầu làm như vậy hoặc theo lệnh của tòa án hoặc của bất kỳ cơ quan chính phủ hoặc cơ quan quản lý nào có thẩm quyền đối với Share2Receive hoặc các chi nhánh của Share2Receive hoặc với lý do chính đáng Share2Receive tin rằng việc truy cập, lưu giữ hoặc tiết lộ đó là cần thiết và chính đáng để: (a) tuân thủ quy trình pháp lý; (b) tuân thủ yêu cầu từ bất kỳ cơ quan chính phủ hoặc cơ quan quản lý nào có thẩm quyền đối với Share2Receive hoặc các chi nhánh có liên quan của Share2Receive; (c) thực thi Điều khoản Dịch vụ của chúng tôi hoặc Chính sách Bảo mật này; (d) phản hồi bất kỳ khiếu nại nào du cho là nguy cơ hoặc đang xảy ra trên thực tế để chống lại Share2Receive hoặc các chi nhánh có liên quan hoặc khiếu nại khác rằng bất kỳ Nội dung nào vi phạm quyền của bên thứ ba; (e) đáp ứng các yêu cầu của bạn về dịch vụ khách hàng; hoặc (f) bảo vệ quyền, tài sản hoặc sự an toàn cá nhân của Share2Receive hoặc các chi nhánh có liên quan, người dùng và / hoặc công chúng.
...
6.3. Vì Các Mục Đích mà chúng tôi sẽ/có thể thu thập, sử dụng, tiết lộ hoặc xử lý dữ liệu cá nhân của bạn phụ thuộc vào hoàn cảnh hiện có, mục đích đó có thể không xuất hiện bên trên. Tuy nhiên, chúng tôi sẽ thông báo cho bạn biết mục đích khác đó tại thời điểm xin sự cho phép của bạn, trừ phi việc xử lý dữ liệu áp dụng mà không có sự đồng ý của bạn là được phép theo các quy định của pháp luật về bảo vệ bí mật thông tin cá nhân hoặc theo quy định pháp luật.`}
      ...
      <h1 className="text-2xl font-semibold">7. Share2Receive BẢO VỆ VÀ LƯU TRỮ THÔNG TIN KHÁCH HÀNG BẰNG CÁCH NÀO?</h1>
      <p className="text-lg whitespace-pre-wrap">
...
7.2. Chúng tôi sẽ duy trì dữ liệu cá nhân tuân theo các quy định của pháp luật về bảo vệ bí mật thông tin cá nhân và/hoặc các điều luật hiện hành khác. Có nghĩa là, chúng tôi sẽ hủy hoặc xóa thông tin nhận dạng ra khỏi dữ liệu cá nhân của bạn khi chúng tôi có lý do hợp lý để xác định rằng (i) việc lưu giữ dữ liệu cá nhân đó không còn phục vụ mục đích thu thập dữ liệu cá nhân đó nữa; (ii) việc lưu giữ không còn cần thiết cho bất kỳ mục đích hợp pháp hay mục đích kinh doanh nào và (iii) không còn các lợi ích hợp pháp nào khác để tiếp tục lưu giữ các dữ liệu cá nhân này. Nếu bạn ngưng sử dụng Nền tảng của chúng tôi, hoặc quyền của bạn được sử dụng Nền tảng và/hoặc Các Dịch Vụ bị chấm dứt hoặc hủy bỏ, chúng tôi có thể tiếp tục lưu, sử dụng và/hoặc tiết lộ dữ liệu cá nhân của bạn tuân theo Chính sách bảo mật này và các nghĩa vụ của chúng tôi theo các quy định của pháp luật về bảo vệ bí mật thông tin cá nhân. Tùy thuộc vào quy định của pháp luật, chúng tôi có thể tiêu hủy dữ liệu cá nhân của bạn một cách an toàn mà không cần thông báo trước cho bạn.`}
      ...
      <h1 className="text-2xl font-semibold">8. Share2Receive CÓ TIẾT LỘ THÔNG TIN THU THẬP TỪ NGƯỜI TRUY CẬP HAY KHÔNG?</h1>
      <p className="text-lg whitespace-pre-wrap">
      ...
      <ul className="list-disc ml-10 text-lg">
        <li>Công ty con, công ty liên kết và công ty liên quan của chúng tôi;</li>
        <li>
          Người ký gửi & cho tặng hoặc người mua mà bạn đã thực hiện giao dịch hoặc tương tác trên Nền tảng hoặc liên
          quan đến việc bạn sử dụng Dịch vụ cho các Mục đích đã nêu ở trên;
        </li>
        <li>Những người sử dụng khác của Nền tảng của chúng tôi cho một hoặc nhiều các Mục đích đã nêu ở trên</li>
        <li>
          Nhà thầu, đại lý, nhà cung cấp dịch vụ và các bên thứ ba khác mà chúng tôi thuê để hỗ trợ hoặc bổ sung cho
          hoạt động kinh doanh của chúng tôi. Những bên này bao gồm, nhưng không giới hạn ở những bên cung cấp các dịch
          vụ quản trị hoặc các dịch vụ khác cho chúng tôi chẳng hạn như công ty bưu chính, công ty viễn thông, đối tác
          quảng cáo và truyền thông, công ty công nghệ thông tin, các tổ chức hoạt động thương mại điện tử, và trung tâm
          dữ liệu
        </li>
        <li>
          Các cơ quan chính phủ hoặc cơ quan quản lý có thẩm quyền đối với Share2Receive hoặc nếu được cho phép theo Mục 6.2;
        </li>
        <li>
          Người mua hoặc người thừa nhiệm khác trong trường hợp sáp nhập, thoái vốn, tái cơ cấu, tái tổ chức, giải thể
          hoặc bán hay chuyển nhượng một phần hoặc tất cả tài sản của Share2Receive, cho dù là vấn đề đang diễn ra hay đang
          trong thủ tục phá sản, thanh lý hoặc thủ tục tương tự, trong đó dữ liệu cá nhân Share2Receive lưu giữ về người dùng
          của chúng tôi nằm trong các tài sản được chuyển nhượng; hoặc cho một bên đối tác trong một giao dịch tài sản
          kinh doanh mà Share2Receive hoặc bất kỳ công ty liên kết hay công ty liên quan nào của nó có tham gia giao dịch; và
        </li>
        <li>
...
8.5. Share2Receive cho phép bạn chia sẻ video từ YouTube trong tính năng Share2Receive Livestream (“Nội Dung YouTube”). Về mặt kỹ thuật, Share2Receive sử dụng Tính Năng YouTube API của chính YouTube. Thông qua việc chia sẻ Nội Dung YouTube, bạn theo đây đồng ý chịu sự điều chỉnh của Chính Sách Bảo Mật của YouTube (http://www.google.com/policies/privacy).

8.6. Như được quy định trong Điều khoản dịch vụ của Share2Receive, Người dùng (bao gồm bất cứ người lao động, đại lý, người đại diện hoặc bất cứ bên nào khác hành động cho Người dùng đó hoặc thay mặt người dùng đó) sở hữu dữ liệu cá nhân của Người dùng khác thông qua việc sử dụng Dịch vụ (“Bên nhận dữ liệu”) tại đây đồng ý rằng, họ sẽ (i) tuân thủ với các quy định của pháp luật về bảo vệ dữ liệu cá nhân liên quan đến các dữ liệu này, bao gồm bất cứ hoạt động thu thập, xử lý, lưu giữ và chuyển giao các dữ liệu này; (ii) cho phép Share2Receive hoặc Người dùng mà dữ liệu cá nhân của Bên nhận được thu thập (“Bên tiết lộ”) được xóa dữ liệu của anh hoặc cô ấy đã bị thu thập khỏi cơ sở dữ liệu của Bên nhận dữ liệu; và (iii) cho phép Share2Receive hoặc Bên tiết lộ dữ liệu được rà soát những nội dung đã bị thu thập liên quan đến họ bởi Bên nhận dữ liệu, trong mỗi trường hợp (ii) và (iii) nêu trên, tuân thủ với và khi được yêu cầu bởi các quy định của pháp luật có liên quan.

8.7. Bất kể quy định nào được quy định tại đây, Người ký gửi & cho tặng (bao gồm bất cứ người lao động, đại lý, người đại diện hoặc bất cứ bên nào khác hành động cho Người dùng đó hoặc thay mặt người dùng đó) phải tuân thủ các quy định của pháp luật có liên quan và, liên quan đến bất cứ dữ liệu cá nhân nào của Người mua nhận được từ Share2Receive, (i) không được cho phép sử dụng các dữ liệu cá nhân của Người mua này trừ khi có lý do chính đáng cần thiết để phản hồi các yêu cầu của Người mua và để thực hiện việc trả lời, xử lý, giải quyết hoặc hoàn thành các giao dịch mà không có sự cho phép trước bằng văn bản của Người mua và Share2Receive; (ii) phải ngưng việc liên lạc với Người mua sử dụng các thông tin này bên ngoài nền tảng Share2Receive; (iii) không được cho phép tiết lộ các dữ liệu cá nhân của Người mua này đến bất cứ bên thứ ba không được phép nào mà không có sự cho phép trước bằng văn bản của Người mua và Share2Receive; (iv) phải thực hiện các biện pháp an ninh thích hợp để bảo vệ từng dữ liệu cá nhân người dùng của Share2Receive mà họ đang sở hữu, chỉ lưu giữ dữ liệu này chừng nào vẫn còn cần thiết cho các mục đích ở trên và phù hợp với quy định của pháp luật bảo vệ dữ liệu cá nhân, và xóa hoặc hoàn trả các dữ liệu này cho Share2Receive theo yêu cầu từ Share2Receive hoặc trong thời gian sớm nhất có thể khi hoàn thành giao dịch; và (v) thông báo cho Bộ phận bảo vệ Dữ liệu Cá nhân của Share2Receive tại share2receivevn@gmail.com trong trường hợp có khả năng vi phạm dữ liệu hoặc mất dữ liệu khác của người dùng này.`}
      </p>
      <h1 className="text-2xl font-semibold">9. THÔNG TIN VỀ TRẺ EM</h1>
      <p className="text-lg whitespace-pre-wrap">
        {`9.1. Các Dịch Vụ này không dành cho trẻ em dưới 13 tuổi. Chúng tôi không cố tình thu thập hay lưu giữ bất kỳ dữ liệu cá nhân hay thông tin không nhận dạng cá nhân nào của bất kỳ ai dưới 13 tuổi, bất kỳ phần nào của Nền tảng của chúng tôi hoặc Các Dịch Vụ khác cũng không dành cho trẻ em dưới 13 tuổi. Bố/mẹ hoặc người giám hộ của trẻ em dưới 13 tuổi vui lòng giám sát và đảm bảo thông tin cá nhân của trẻ dưới 13 tuổi mà mình đang giám hộ không đăng tải thông tin cá nhân cho Share2Receive. Trong trường hợp thông tin cá nhân của của trẻ em dưới 13 tuổi do quý phụ huynh giám hộ được cung cấp cho Share2Receive, Bố/mẹ hoặc người giám hộ theo đồng ý với việc xử lý thông tin của trẻ em dưới 13 tuổi có liên quan, và đồng ý chịu sự điều chỉnh của Chính Sách này thay mặt cho người được giám hộ. Chúng tôi sẽ khóa bất kỳ tài khoản nào chỉ được sử dụng bởi đối tượng trẻ em như vậy và sẽ gỡ và/hoặc xóa bất kỳ dữ liệu cá nhân nào mà chúng tôi cho là đã được gửi bởi bất kỳ trẻ em nào dưới 13 tuổi.`}
      </p>
      <h1 className="text-2xl font-semibold">10. THÔNG TIN THU THẬP BỞI CÁC BÊN THỨ BA</h1>
      <p className="text-lg whitespace-pre-wrap">
...
11.3. Do đó chúng tôi không chịu trách nhiệm hay trách nhiệm pháp lý đối với nội dung, các biện pháp bảo mật (hoặc sự thiếu biện pháp bảo mật) và các hoạt động của các trang web/ứng dụng/dịch vụ được liên kết này. Những trang web/ứng dụng/dịch vụ được liên kết này chỉ vì sự thuận tiện cho bạn và do đó bạn tự chịu trách nhiệm khi truy cập chúng. Tuy nhiên, chúng tôi tìm cách bảo vệ tính toàn vẹn của Nền tảng của chúng tôi và các liên kết được đặt trên từng trang web đó và do đó chúng tôi hoan nghênh ý kiến phản hồi về các trang web được liên kết này (bao gồm nếu một trang web cụ thể không hoạt động).`}
      ...
      <h1 className="text-2xl font-semibold">12. Share2Receive SẼ CHUYỂN THÔNG TIN CỦA BẠN RA NƯỚC NGOÀI?</h1>
      <p className="text-lg whitespace-pre-wrap">
        {`12.1. Thông tin và/hoặc dữ liệu cá nhân của bạn có thể được chuyển ra nước ngoài, lưu trữ hoặc xử lý bên ngoài quốc gia của bạn cho một hoặc nhiều Mục đích. Trong phần lớn các trường hợp, dữ liệu cá nhân của bạn sẽ được xử lý bởi chúng tôi tại Việt Nam, nơi đặt các máy chủ của chúng tôi. Share2Receive sẽ chỉ chuyển dữ liệu cá nhân của bạn ra nước ngoài khi phù hợp với các quy định của pháp luật về bảo vệ dữ liệu cá nhân.`}
      </p>
      <h1 className="text-2xl font-semibold">
        13. BẠN CÓ THỂ RÚT TÊN, XÓA TÊN, YÊU CẦU TRUY CẬP HOẶC ĐIỀU CHỈNH THÔNG TIN BẠN ĐÃ CUNG CẤP CHO CHÚNG TÔI BẰNG
        CÁCH NÀO?
      </h1>
      <p className="text-lg whitespace-pre-wrap">
        {`13.1. Rút Lại Sự Đồng Ý

13.1.1. Bạn có thể rút lại sự đồng ý cho phép thu thập, sử dụng và/hoặc tiết lộ và/hoặc yêu cầu xóa dữ liệu cá nhân của bạn mà chúng tôi đang lưu giữ hoặc kiểm soát bằng cách gửi email cho Chuyên viên Bảo Vệ Dữ Liệu Cá Nhân của chúng tôi tại địa chỉ email share2receivevn@gmail.com hoặc qua ĐÂY, và chúng tôi sẽ xử lý các yêu cầu này theo Chính Sách Bảo Mật cũng như quy định pháp luật có liên quan. Tuy nhiên, việc bạn rút lại sự cho phép của bạn có thể đồng nghĩa với việc chúng tôi sẽ không thể tiếp tục cung cấp các Dịch vụ đến bạn và chúng tôi có thể cần phải chấm dứt mối quan hệ hiện tại giữa bạn và/hoặc hợp đồng mà bạn có với Chúng tôi.

13.1.2. Khi bạn chia sẻ nội dung trên YouTube, bên cạnh việc rút lại sự cho phép của bạn bằng việc gửi email cho chúng tôi phù hợp với quy định tại Điều 13.1.1, bạn cũng có thể rút lại quyền truy cập của Share2Receive vào dữ liệu cá nhân của bạn thông qua trang cài đặt an ninh của Google tại địa chỉ https://security.google.com/settings/security/permissions.
...
13.2.3. Chúng tôi bảo lưu quyền từ chối sửa dữ liệu cá nhân của bạn theo các quy định của pháp luật về bảo vệ bí mật thông tin cá nhân, trường hợp các điều luật đó yêu cầu và/hoặc cho phép một tổ chức từ chối sửa dữ liệu cá nhân trong các trường hợp như thế.`}
      ...
      <h1 className="text-2xl font-semibold">14. THẮC MẮC, QUAN NGẠI HOẶC KHIẾU NẠI? LIÊN HỆ VỚI CHÚNG TÔI</h1>
      <p className="text-lg whitespace-pre-wrap">
        {`14.1. Nếu bạn có bất kỳ thắc mắc hoặc khiếu nại nào về các phương pháp bảo vệ quyền riêng tư của chúng tôi vui lòng liên hệ với chúng tôi tại ĐÂY.

Bản Cập Nhật ngày 12/12/2024.
Phiên bản này có hiệu lực vào ngày 14/12/2024.`}
      </p>
    </div>
  )
}
